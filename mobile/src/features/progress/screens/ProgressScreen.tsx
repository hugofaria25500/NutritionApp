...
grid:{width:"100%",flexDirection:"row",flexWrap:"wrap",gap:7,marginTop:8},smallCard:{width:"48.8%",minHeight:108,padding:9,borderRadius:13,backgroundColor:"rgba(255,255,255,.78)",borderWidth:1,borderColor:"rgba(20,59,51,.05)"},smallHeader:{flexDirection:"row",alignItems:"center",justifyContent:"space-between"},smallTitle:{fontFamily:"PlusJakartaSans_700Bold",fontSize:9,color:COLORS.ink},bigMetric:{marginTop:8,fontFamily:"PlusJakartaSans_700Bold",fontSize:13,color:COLORS.ink},changeRow:{flexDirection:"row",alignItems:"center",gap:5,marginTop:2},change:{fontFamily:"PlusJakartaSans_600SemiBold",fontSize:7,color:"#2D8C45"},caption:{fontFamily:"PlusJakartaSans_400Regular",fontSize:7,color:"#7B8985"},chart:{height:45,marginTop:7,flexDirection:"row",alignItems:"flex-end",justifyContent:"space-between",paddingHorizontal:3},barWrap:{height:"100%",alignItems:"center",justifyContent:"flex-end",gap:2},bar:{width:6,borderRadius:3,backgroundColor:"#CFE5D3"},activeBar:{backgroundColor:COLORS.darkGreen},barLabel:{fontFamily:"PlusJakartaSans_400Regular",fontSize:5,color:"#8A9693"},goalTitle:{marginTop:7,fontFamily:"PlusJakartaSans_600SemiBold",fontSize:7,color:"#34514C"},goalSub:{marginTop:2,fontFamily:"PlusJakartaSans_400Regular",fontSize:6,color:COLORS.muted},goalTrack:{height:4,borderRadius:2,backgroundColor:"#DCE8DE",overflow:"hidden",marginTop:7},fill:{height:"100%",backgroundColor:COLORS.darkGreen,borderRadius:2},goalBadge:{marginTop:7,padding:5,borderRadius:7,backgroundColor:"#F8F1D9",flexDirection:"row",gap:4,alignItems:"center"},badgeText:{flex:1,fontFamily:"PlusJakartaSans_500Medium",fontSize:8,color:"#806B2D"},lineChart:{height:43,marginTop:6,borderBottomWidth:1,borderBottomColor:"#DCE5E0",position:"relative"},lineBase:{position:"absolute",left:"5%",right:"5%",top:26,height:1,backgroundColor:"#DCE5E0"},linePoint:{position:"absolute",width:6,height:6,borderRadius:3,backgroundColor:COLORS.darkGreen},chartDates:{flexDirection:"row",justifyContent:"space-between",marginTop:3},insightHeader:{marginTop:10,marginBottom:6,flexDirection:"row",justifyContent:"space-between",alignItems:"center"},sectionTitle:{fontFamily:"PlusJakartaSans_700Bold",fontSize:10,color:COLORS.ink},seeAll:{fontFamily:"PlusJakartaSans_600SemiBold",fontSize:8,color:COLORS.darkGreen},insights:{flexDirection:"row",gap:6,paddingBottom:4},insight:{flex:1,minHeight:73,padding:7,borderRadius:11,backgroundColor:"rgba(255,255,255,.78)"},insightIcon:{width:22,height:22,borderRadius:11,backgroundColor:"#EDF5EC",alignItems:"center",justifyContent:"center",marginBottom:4},insightTitle:{fontFamily:"PlusJakartaSans_700Bold",fontSize:8,lineHeight:8,color:COLORS.ink},insightDetail:{marginTop:3,fontFamily:"PlusJakartaSans_400Regular",fontSize:7,lineHeight:7,color:COLORS.muted}
});
