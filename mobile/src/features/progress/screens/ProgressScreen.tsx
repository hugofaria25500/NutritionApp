          ...
          <View style={styles.grid}>
            ...
            <View style={styles.smallCard}>
              ...
              <View style={styles.weightRange}>
                <Text style={styles.weightRangeText}>70,6 kg</Text>
