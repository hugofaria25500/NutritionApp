                  ...
                  return (
                    <View
                      ...
                      style={[
                        ...
                        {
                          left: `${(index / (weeklyCalories.length - 1)) * 100}%`,
                          top: `${midY}%`,
